...
type MsgCreateMailbox struct {
	...
	DefaultIsm  github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,3,opt,name=default_ism,json=defaultIsm,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"default_ism"`
	// default_hook ...
	DefaultHook *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,4,opt,name=default_hook,json=defaultHook,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"default_hook,omitempty"`
	// required_hook ...
	RequiredHook *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,5,opt,name=required_hook,json=requiredHook,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"required_hook,omitempty"`
}
...
type MsgSetMailbox struct {
	...
	Owner string `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner,omitempty"`
	// mailbox_id
	MailboxId github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,2,opt,name=mailbox_id,json=mailboxId,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"mailbox_id"`
	// default_ism ...
	DefaultIsm *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,3,opt,name=default_ism,json=defaultIsm,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"default_ism,omitempty"`
	// default_hook ...
	DefaultHook *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,4,opt,name=default_hook,json=defaultHook,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"default_hook,omitempty"`
	// required_hook ...
	RequiredHook *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,5,opt,name=required_hook,json=requiredHook,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"required_hook,omitempty"`
...
type MsgProcessMessage struct {
	// mailbox_id ...
	MailboxId github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,1,opt,name=mailbox_id,json=mailboxId,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"mailbox_id"`
	// relayer ...
...
var fileDescriptor_fbb8ebe75a427476 = []byte{
	...
	,
}
