...
type MsgCreateCollateralToken struct {
	...
	OriginMailbox github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,2,opt,name=origin_mailbox,json=originMailbox,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"origin_mailbox"`
...
type MsgSetToken struct {
	// owner is the message sender.
	Owner    string                                                   `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner,omitempty"`
	TokenId  github_com_troykessler_hyperlane_cosmos_util.HexAddress  `protobuf:"bytes,2,opt,name=token_id,json=tokenId,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"token_id"`
	NewOwner string                                                   `protobuf:"bytes,3,opt,name=new_owner,json=newOwner,proto3" json:"new_owner,omitempty"`
	IsmId    *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,4,opt,name=ism_id,json=ismId,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"ism_id,omitempty"`
}
...
type MsgRemoteTransfer struct {
	...
	Recipient         github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,4,opt,name=recipient,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"recipient"`
	Amount            cosmossdk_io_math.Int                                   `protobuf:"bytes,5,opt,name=amount,proto3,customtype=cosmossdk.io/math.Int" json:"amount"`
	// Post Dispatch
	CustomHookId       *github_com_troykessler_hyperlane_cosmos_util.HexAddress `protobuf:"bytes,6,opt,name=custom_hook_id,json=customHookId,proto3,customtype=github.com/troykessler/hyperlane-cosmos/util.HexAddress" json:"custom_hook_id,omitempty"`
...
var fileDescriptor_9d1a3f4c9d53a091 = []byte{
	...
	,
}
